...
<div class="container">
        <center>
        <div class="card-body">
        <table ><form action="additem.php" method="post">
                <tr>
                    <th>Meat Type</th>
                    <td><input type="text" placeholder="Meat Type" name="meattype"></td>
</tr>
<tr>
                    <th>Price</th>
...
<tr>          
                ...
                <tr>
                <th></th>
                    <td><button type="submit" id = "addnew" style="padding-left: 59px; padding-right: 59px;">Add Item</td>
                </tr>
                </form>
            </table>
<div>
